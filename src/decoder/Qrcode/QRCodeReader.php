<?php
    ...
    namespace Coco\qrcode\decoder\Qrcode;

    use Coco\qrcode\decoder\BinaryBitmap;
    use Coco\qrcode\decoder\ChecksumException;
    use Coco\qrcode\decoder\Common\BitMatrix;
    use Coco\qrcode\decoder\FormatException;
    use Coco\qrcode\decoder\NotFoundException;
    use Coco\qrcode\decoder\Qrcode\Decoder\Decoder;
    use Coco\qrcode\decoder\Qrcode\Detector\Detector;
    use Coco\qrcode\decoder\Reader;
    use Coco\qrcode\decoder\Result;
