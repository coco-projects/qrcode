...
final class AlignmentPatternFinder
{
    ...
    /**
     * @param array $stateCount count of black/white/black pixels just read
     *
     * @return bool iff the proportions of the counts is close enough to the 1/1/1 ratios used by alignment
     ...
     */
    private function crossCheckVertical(int $startI, int $centerJ, $maxCount, $originalStateCountTotal)
    {
        $image = $this->image;
