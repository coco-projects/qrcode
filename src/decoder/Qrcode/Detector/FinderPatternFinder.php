...
class FinderPatternFinder
{
    ...
    final public function find(array|null $hints): FinderPatternInfo
    {
     ...
     * @param float $maxVariance
     *
     * @return bool iff the proportions of the counts is close enough to the 1/1/3/1/1 ratios used by finder
     ...
     */
    private function crossCheckVertical(int $startI, int $centerJ, int $maxCount, int|float $originalStateCountTotal)
    {
        $image = $this->image;
     ...
     */
    private function crossCheckHorizontal(int $startJ, int $centerI, int $maxCount, int|float $originalStateCountTotal)
    {
        $image = $this->image;
    ...
    /**
     * @return bool iff we have found at least 3 finder patterns that have been detected at least
     *              {@link #CENTER_QUORUM} times each, and, the estimated module size of the candidates is "pretty
     *              similar"
     */
