...
final class DataBlock
{
     ...
     *
     * @return \Zxing\Qrcode\Decoder\DataBlock[] DataBlocks containing original bytes, "de-interleaved" from
     *                                           representation in the QR Code
     */
    public static function getDataBlocks($rawCodewords, Version $version, ErrorCorrectionLevel $ecLevel): array
    {
